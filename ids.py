"""Intrusion detection: flags MQTT floods, replayed payloads, and
tamper events, logging them to the security_log table."""
...
msg_times     = deque()
recent_hashes = {}   # payload hash -> last seen timestamp
event_count   = 0
